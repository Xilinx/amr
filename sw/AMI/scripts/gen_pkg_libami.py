...
def main(args):
    ...
    try:
        ...
        config['pkg']['deps'] = {
            'rpm': ['glibc', 'gcc', 'make', 'grep', 'gawk', 'build-essential'],
        ...
        config['pkg']['pkg_config_pc']  = config['pkg']['pkg_config_dir'] + '/libami.pc'
        ...
        api_include_dest = [
            {
                ...
                'dst': join(config['pkg']['usr_include_dir'],
                           os.path.dirname(f).replace('api/build', 'api/include'))
