...
def main(args):
    ...
    try:
        ...
        # Init
        config['vendor']            = {}
        config['vendor']['name']    = 'AMD'
        config['vendor']['full']    = 'AMD Inc'
        config['vendor']['email']   = 'support@amd.com'
        ...
        SRC_DEST_LIST = [
            ...
            {'src': os.path.abspath(join(ROOT_DIR,    'fw',  'AMC', 'build', 'amc_ospi.bin')),  'dst': config['package']['opt_dir']},
            {'src': os.path.abspath(join(ROOT_DIR,    'fw',  'AMC', 'build', 'amc_ospi_fpt.bin')),'dst': config['package']['opt_dir']},
            *api_dest,
            *driver_dest
        ]
