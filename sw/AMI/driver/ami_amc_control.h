 ...
 * @GCQ_SUBMIT_CMD_SET_FPT_PARTITION: Set FPT partition
...
enum gcq_submit_cmd_req {
	...
	GCQ_SUBMIT_CMD_SET_FPT_PARTITION	= 0x07,
 ...
 * @AMC_CMD_ID_SET_FPT_PARTITION: set FPT partition command
