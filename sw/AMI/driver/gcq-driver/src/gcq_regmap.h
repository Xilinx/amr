...
#define GCQ_PRODUCER_SQ_QUEUE_MEM_ADDR_LOW                  ( 0x0008 )  /* RW */

#define GCQ_PRODUCER_SQ_RESET_INTERRUPT_CTRL                ( 0x000C )  /* RW */
#define GCQ_PRODUCER_SQ_RESET_INTERRUPT_CTRL_ENABLE_MASK    BIT( 0 )
...
#define GCQ_PRODUCER_SQ_QUEUE_MEM_ADDR_HIGH                 ( 0x0010 )  /* RW */

#define GCQ_PRODUCER_CQ_TAIL_POINTER                        ( 0x0100 )  /* RO */

#define GCQ_PRODUCER_CQ_INTERRUPT_STATUS                    ( 0x0104 )  /* RO */
#define GCQ_PRODUCER_CQ_INTERRUPT_REG_INT_STATUS_MASK       BIT( 0 )

#define GCQ_PRODUCER_CQ_QUEUE_MEM_ADDR_LOW                  ( 0x0108 )  /* RO */

#define GCQ_PRODUCER_CQ_RESET_INTERRUPT_CTRL                ( 0x010C )  /* RO */
#define GCQ_PRODUCER_CQ_RESET_INTERRUPT_CTRL_ENABLE_MASK    BIT( 0 )
#define GCQ_PRODUCER_CQ_RESET_INTERRUPT_CTRL_TYPE_MASK      BIT( 1 )    /* RO */

#define GCQ_PRODUCER_CQ_QUEUE_MEM_ADDR_HIGH                 ( 0x0110 )  /* RO */
...
#define GCQ_CONSUMER_CQ_QUEUE_MEM_ADDR_LOW                  ( 0x0108 )  /* RW */
...
#define GCQ_CONSUMER_CQ_QUEUE_MEM_ADDR_HIGH                 ( 0x0110 )  /* RW */
...
#define GCQ_CONSUMER_CQ_QUEUE_MEM_ADDR_LOW                  ( 0x0008 )  /* RW */

#define GCQ_CONSUMER_CQ_RESET_INTERRUPT_CTRL                ( 0x000C )  /* RW */
#define GCQ_CONSUMER_CQ_RESET_INTERRUPT_CTRL_ENABLE_MASK    BIT( 0 )
#define GCQ_CONSUMER_CQ_RESET_INTERRUPT_CTRL_TYPE_MASK      BIT( 1 )    /* RW */

#define GCQ_CONSUMER_CQ_QUEUE_MEM_ADDR_HIGH                 ( 0x0010 )  /* RW */

#define GCQ_CONSUMER_SQ_TAIL_POINTER                        ( 0x0100 )  /* RO */
#endif

#define GCQ_CONSUMER_SQ_INTERRUPT_REG                       ( 0x0104 )  /* RO */
#define GCQ_CONSUMER_SQ_INTERRUPT_REG_INT_STATUS_MASK       BIT( 0 )

#define GCQ_CONSUMER_SQ_QUEUE_MEM_ADDR_LOW                  ( 0x0108 )  /* RO */

#define GCQ_CONSUMER_SQ_RESET_INTERRUPT_CTRL                ( 0x010C )  /* RO */
#define GCQ_CONSUMER_SQ_RESET_INTERRUPT_CTRL_ENABLE_MASK    BIT( 0 )

#define GCQ_CONSUMER_SQ_QUEUE_MEM_ADDR_HIGH                 ( 0x0110 )  /* RO */
