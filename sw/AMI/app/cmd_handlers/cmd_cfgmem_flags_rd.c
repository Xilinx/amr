...
/*
 * cmd_cfgmem_flags_rd.c - This file contains the implementation for the command "cfgmem_flags_rd"
 *
...
/**
 * do_cmd_cfgmem_flags_rd() - "cfgmem_flags_rd" command callback.
 ...
 */
static int do_cmd_cfgmem_flags_rd(struct app_option *options, int num_args, char **args);
...
static const char help_msg[] = \
	...
	"\r\nUsage:\r\n"
	"\t" APP_NAME " cfgmem_flags_rd -d <bdf> -t <type> -p <n>\r\n"
	"\r\nOptions:\r\n"
...
struct app_cmd cmd_cfgmem_flags_rd = {
	.callback      = &do_cmd_cfgmem_flags_rd,
...
/**
 * "cfgmem_flags_rd" command callback.
 * @options:  Ordered list of options passed in at the command line
 * @num_args:  Number of non-option arguments (excluding command)
 * @args:  List of non-option arguments (excluding command)
 *
