    ...
    "cells": {
      ...
      "ps": {
        ...
        "destinations": [
          ...
          {"name": "PMC_OSPI_mem", "addr": "0xc0000000", "size": "512M", "mem": true, "nodeid": "0x18900000"},
          ...
          {"name": "RPU0_TCMA_mem_lockstep", "addr": "0xffe10000", "size": "64K", "mem": true, "nodeid": "0x18900001"},
          {"name": "RPU0_TCMB_mem", "addr": "0xffe20000", "size": "64K", "mem": true, "nodeid": "0x1831800c"},
          {"name": "RPU0_TCMB_mem_lockstep", "addr": "0xffe30000", "size": "64K", "mem": true, "nodeid": "0x18900002"},
          ...
          {"name": "OCM_mem", "addr": "0xfffc0000", "size": "256K", "mem": true, "nodeid": "0x18900003"},
    ...
    "subsystems": {
      ...
      "apu_subsystem": {
        ...
        "access": [
          ...
          {
            "name": "access_user_apu",
            "destinations": ["LPD_GPIO", "PMC_RTC", "TTC2", "TTC3", "UART1"],
            "flags": {"requested": true},
            "SMIDs": ["APU"]
          },
          {
            "name": "access_user_apu_ipi",
            "destinations": ["IPI0", "IPI1", "IPI2"],
            "SMIDs": ["APU"]
          },
          {
            "name": "access_user_apu_mem",
            "destinations": ["OCM_mem"],
            "SMIDs": ["APU"]
          },
          {
            "name": "access_user_apu_dma",
            "destinations": [
              "LPD_DMA_CH0",
              "LPD_DMA_CH1",
              "LPD_DMA_CH2",
