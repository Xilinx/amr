...
} __attribute__ ( ( __packed__ ) ) PLDMCommonHeaderPdr;

/**
 * @struct    PLDMNumericSensorRangeFormat
...
} __attribute__ ( ( __packed__ ) ) PLDMNumericSensorRangeFormat;

/**
 * @struct    PLDMNumericSensorPdr
 * @brief   The numeric sensor PDR format
 */
typedef struct
{
    PLDMCommonHeaderPdr          xCommonPdrHeader;
    ...
    PLDMNumericSensorRangeFormat xRange;
} __attribute__ ( ( __packed__ ) ) PLDMNumericSensorPdr;

/**
 * @struct    PLDMNumericSensorNamePdr
 * @brief   The numeric sensor names PDR format
 */
typedef struct
{
    PLDMCommonHeaderPdr xCommonHeader;
    uint16_t            usPldmTerminusHandle;
    uint16_t            usSensorId;
...
} __attribute__ ( ( __packed__ ) ) PLDMNumericSensorNamePdr;
