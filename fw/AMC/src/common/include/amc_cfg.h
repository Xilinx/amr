...
#define AMC_CFG_APC_PREREQUISITES            ( AMC_CFG_OSPI_FAL_INITIALISED )

#define AMC_CFG_AXC_PREREQUISITES            ( AMC_CFG_I2C_INITIALISED | \
                                               AMC_CFG_MUXED_DEVICE_FAL_INITIALISED )
#define AMC_CFG_ASC_PREREQUISITES            ( AMC_CFG_I2C_INITIALISED | \
                                               AMC_CFG_AXC_INITIALISED )
#define AMC_CFG_ASC_MUX_PREREQUISITES        ( AMC_CFG_I2C_INITIALISED |              \
                                               AMC_CFG_MUXED_DEVICE_FAL_INITIALISED | \
                                               AMC_CFG_AXC_INITIALISED )

#define AMC_CFG_AMI_PREREQUISITES            ( AMC_CFG_GCQ_FAL_INITIALISED )

#define AMC_CFG_BMC_PREREQUISITES            ( AMC_CFG_SMBUS_PCIE_LINK_INITIALISED | \
                                               AMC_CFG_SMBUS_FAL_INITIALISED )

#define AMC_CFG_ASDM_PREREQUISITES           ( AMC_CFG_APC_INITIALISED |     \
                                               AMC_CFG_ASC_INITIALISED |     \
                                               AMC_CFG_EEPROM_INITIALISED )

#define AMC_CFG_IN_BAND_PREREQUISITES        ( AMC_CFG_AMI_INITIALISED |     \
                                               AMC_CFG_ASDM_INITIALISED )

#define AMC_CFG_OUT_OF_BAND_PREREQUISITES    ( AMC_CFG_ASC_INITIALISED |     \
