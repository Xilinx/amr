 ...
 *
 * This file contains the hal profile for the V70
 *
 * @file profile_hal.h
 */
...
/* TODO: EEPROM Device ID verification should be fixed for v70 */
#define HAL_EEPROM_VERSION            ( EEPROM_VERSION_3_1 )
...
/* TODO: Remove definitions for peripheral CIPS_PSPMC_0_PSV_I2C_1 (not used v70) */
...
#define HAL_I2C_SW_RESET_BASEADDR     ( XPAR_CIPS_PSPMC_0_PSV_CRL_0_S_AXI_BASEADDR )
