...
BIMEvent PROFILE_BIM_APC_EVENTS[ MAX_APC_PROXY_DRIVER_EVENTS ] =
{
    ...
    { APC_PROXY_DRIVER_E_PROGRAM_STARTED,           0, BIM_STATUS_HEALTHY  },
    { APC_PROXY_DRIVER_E_PROGRAM_COMPLETE,          0, BIM_STATUS_HEALTHY  },
    { APC_PROXY_DRIVER_E_PROGRAM_BUSY,              0, BIM_STATUS_HEALTHY  },
    { APC_PROXY_DRIVER_E_PROGRAM_FAILED,            0, BIM_STATUS_CRITICAL },
