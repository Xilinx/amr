...
#define HAL_I2C_BUS_1_HW_DEVICE_RESET ( FALSE )

#define HAL_I2C_SW_RESET_BASEADDR     ( 0xFF5E0000 )
...
#define HAL_I2C_BUS_1_HW_RESET_ADDR   ( 0 )
#define HAL_I2C_BUS_1_HW_RESET_MASK   ( 0 )
...
extern const uint64_t HAL_RPU_SHARED_MEMORY_BASE_ADDR;
...
#define HAL_IO_WRITE32_NO_FLUSH( val, addr ) ( ( void ) ( val ), ( void ) ( addr ) )
#endif
...
#define HAL_IO_READ32_NO_FLUSH( addr ) ( 0 )
#endif

/* Proxies */
/* APC */
#define HAL_APC_PMC_BOOT_REG ( HAL_USER_CLOCK_CONTROL_BASE_ADDRESS + 0x00004 )
#define HAL_APC_PMC_SRST_REG ( HAL_USER_CLOCK_CONTROL_BASE_ADDRESS + 0x20084 )
