...
#define HAL_BASE_LOGIC_GCQ_M2R_S01_AXI_BASEADDR ( 0x38000000 )
#define HAL_RPU_SHARED_MEMORY_BASE_ADDR         ( HAL_BASE_LOGIC_GCQ_M2R_S01_AXI_BASEADDR + 0x1000)
#define HAL_RPU_SHARED_MEMORY_END_ADDR          ( 0x3FFF0000 )
...
#define HAL_RPU_MEMORY_BUFFER_BASE              ( 0x38000000 + 0x2000000 ) /* 32MB - 128MB RPU Memory (0-32MB RPU code/data) */
