...
typedef enum
{
    FW_IF_SMBUS_CMD_CODE_QUICK_COMMAND_LO                = 0x80,
    FW_IF_SMBUS_CMD_CODE_QUICK_COMMAND_HI                = 0x81,
    FW_IF_SMBUS_CMD_CODE_SEND_BYTE                       = 0x82,
    FW_IF_SMBUS_CMD_CODE_RECEIVE_BYTE                    = 0x83,
    FW_IF_SMBUS_CMD_CODE_WRITE_BYTE                      = 0x84,
    FW_IF_SMBUS_CMD_CODE_WRITE_WORD                      = 0x85,
    FW_IF_SMBUS_CMD_CODE_READ_BYTE                       = 0x86,
    FW_IF_SMBUS_CMD_CODE_READ_WORD                       = 0x87,
    FW_IF_SMBUS_CMD_CODE_PROCESS_CALL                    = 0x88,
    FW_IF_SMBUS_CMD_CODE_BLK_WRITE                       = 0x0F,
    FW_IF_SMBUS_CMD_CODE_BLK_READ                        = 0x8A,
    FW_IF_SMBUS_CMD_CODE_BLK_WRITE_BLK_READ_PROCESS_CALL = 0x8B,
    FW_IF_SMBUS_CMD_CODE_HOST_NOTIFY                     = 0x8C,
    FW_IF_SMBUS_CMD_CODE_WRITE_32                        = 0x8D,
    FW_IF_SMBUS_CMD_CODE_READ_32                         = 0x8E,
    FW_IF_SMBUS_CMD_CODE_WRITE_64                        = 0x8F,
    FW_IF_SMBUS_CMD_CODE_READ_64                         = 0x90,
    FW_IF_SMBUS_CMD_CODE_PREPARE_TO_ARP                  = 0x91,
    FW_IF_SMBUS_CMD_CODE_RESET_DEVICE                    = 0x92,
    FW_IF_SMBUS_CMD_CODE_GET_UDID                        = 0x93,
    FW_IF_SMBUS_CMD_CODE_ASSIGN_ADDRESS                  = 0x94,
    FW_IF_SMBUS_CMD_CODE_GET_UDID_DIRECTED               = 0x95,
    FW_IF_SMBUS_CMD_CODE_RESET_DEVICE_DIRECTED           = 0x96,
    FW_IF_SMBUS_CMD_CODE_NONE                            = 0x97,
